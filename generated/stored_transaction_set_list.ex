defmodule StellarBase.XDR.StoredTransactionSetList do
  @moduledoc """
  ...
  Representation of Stellar `StoredTransactionSetList` type.
  """

  @behaviour XDR.Declaration

  alias StellarBase.XDR.StoredTransactionSet

  @array_type StoredTransactionSet

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(StoredTransactionSet.t())}

  defstruct [:items]

  @spec new(items :: list(StoredTransactionSet.t())) :: t()
