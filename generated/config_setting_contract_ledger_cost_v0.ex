defmodule StellarBase.XDR.ConfigSettingContractLedgerCostV0 do
  ...
  @type bucket_list_target_size_bytes_type :: Int64.t()
  @type write_fee1_kb_bucket_list_low_type :: Int64.t()
  @type write_fee1_kb_bucket_list_high_type :: Int64.t()
  @type bucket_list_write_fee_growth_factor_type :: Uint32.t()

  @type t :: %__MODULE__{ledger_max_read_ledger_entries: ledger_max_read_ledger_entries_type(), ledger_max_read_bytes: ledger_max_read_bytes_type(), ledger_max_write_ledger_entries: ledger_max_write_ledger_entries_type(), ledger_max_write_bytes: ledger_max_write_bytes_type(), tx_max_read_ledger_entries: tx_max_read_ledger_entries_type(), tx_max_read_bytes: tx_max_read_bytes_type(), tx_max_write_ledger_entries: tx_max_write_ledger_entries_type(), tx_max_write_bytes: tx_max_write_bytes_type(), fee_read_ledger_entry: fee_read_ledger_entry_type(), fee_write_ledger_entry: fee_write_ledger_entry_type(), fee_read1_kb: fee_read1_kb_type(), bucket_list_target_size_bytes: bucket_list_target_size_bytes_type(), write_fee1_kb_bucket_list_low: write_fee1_kb_bucket_list_low_type(), write_fee1_kb_bucket_list_high: write_fee1_kb_bucket_list_high_type(), bucket_list_write_fee_growth_factor: bucket_list_write_fee_growth_factor_type()}

  defstruct [:ledger_max_read_ledger_entries, :ledger_max_read_bytes, :ledger_max_write_ledger_entries, :ledger_max_write_bytes, :tx_max_read_ledger_entries, :tx_max_read_bytes, :tx_max_write_ledger_entries, :tx_max_write_bytes, :fee_read_ledger_entry, :fee_write_ledger_entry, :fee_read1_kb, :bucket_list_target_size_bytes, :write_fee1_kb_bucket_list_low, :write_fee1_kb_bucket_list_high, :bucket_list_write_fee_growth_factor]

  @spec new(ledger_max_read_ledger_entries :: ledger_max_read_ledger_entries_type(), ledger_max_read_bytes :: ledger_max_read_bytes_type(), ledger_max_write_ledger_entries :: ledger_max_write_ledger_entries_type(), ledger_max_write_bytes :: ledger_max_write_bytes_type(), tx_max_read_ledger_entries :: tx_max_read_ledger_entries_type(), tx_max_read_bytes :: tx_max_read_bytes_type(), tx_max_write_ledger_entries :: tx_max_write_ledger_entries_type(), tx_max_write_bytes :: tx_max_write_bytes_type(), fee_read_ledger_entry :: fee_read_ledger_entry_type(), fee_write_ledger_entry :: fee_write_ledger_entry_type(), fee_read1_kb :: fee_read1_kb_type(), bucket_list_target_size_bytes :: bucket_list_target_size_bytes_type(), write_fee1_kb_bucket_list_low :: write_fee1_kb_bucket_list_low_type(), write_fee1_kb_bucket_list_high :: write_fee1_kb_bucket_list_high_type(), bucket_list_write_fee_growth_factor :: bucket_list_write_fee_growth_factor_type()) :: t()
  def new(
  ...
  def decode_xdr(bytes, struct) do
    case XDR.Struct.decode_xdr(bytes, struct) do
      {:ok, {%XDR.Struct{components: [ledger_max_read_ledger_entries: ledger_max_read_ledger_entries, ledger_max_read_bytes: ledger_max_read_bytes, ledger_max_write_ledger_entries: ledger_max_write_ledger_entries, ledger_max_write_bytes: ledger_max_write_bytes, tx_max_read_ledger_entries: tx_max_read_ledger_entries, tx_max_read_bytes: tx_max_read_bytes, tx_max_write_ledger_entries: tx_max_write_ledger_entries, tx_max_write_bytes: tx_max_write_bytes, fee_read_ledger_entry: fee_read_ledger_entry, fee_write_ledger_entry: fee_write_ledger_entry, fee_read1_kb: fee_read1_kb, bucket_list_target_size_bytes: bucket_list_target_size_bytes, write_fee1_kb_bucket_list_low: write_fee1_kb_bucket_list_low, write_fee1_kb_bucket_list_high: write_fee1_kb_bucket_list_high, bucket_list_write_fee_growth_factor: bucket_list_write_fee_growth_factor]}, rest}} ->
        {:ok, {new(ledger_max_read_ledger_entries, ledger_max_read_bytes, ledger_max_write_ledger_entries, ledger_max_write_bytes, tx_max_read_ledger_entries, tx_max_read_bytes, tx_max_write_ledger_entries, tx_max_write_bytes, fee_read_ledger_entry, fee_write_ledger_entry, fee_read1_kb, bucket_list_target_size_bytes, write_fee1_kb_bucket_list_low, write_fee1_kb_bucket_list_high, bucket_list_write_fee_growth_factor), rest}}
      error -> error
    end
  end
  ...
  def decode_xdr!(bytes, struct) do
    {%XDR.Struct{components: [ledger_max_read_ledger_entries: ledger_max_read_ledger_entries, ledger_max_read_bytes: ledger_max_read_bytes, ledger_max_write_ledger_entries: ledger_max_write_ledger_entries, ledger_max_write_bytes: ledger_max_write_bytes, tx_max_read_ledger_entries: tx_max_read_ledger_entries, tx_max_read_bytes: tx_max_read_bytes, tx_max_write_ledger_entries: tx_max_write_ledger_entries, tx_max_write_bytes: tx_max_write_bytes, fee_read_ledger_entry: fee_read_ledger_entry, fee_write_ledger_entry: fee_write_ledger_entry, fee_read1_kb: fee_read1_kb, bucket_list_target_size_bytes: bucket_list_target_size_bytes, write_fee1_kb_bucket_list_low: write_fee1_kb_bucket_list_low, write_fee1_kb_bucket_list_high: write_fee1_kb_bucket_list_high, bucket_list_write_fee_growth_factor: bucket_list_write_fee_growth_factor]}, rest} =
