defmodule StellarBase.XDR.HashIDPreimageCreateContractArgs do
  ...
  @type t :: %__MODULE__{network_id: network_id_type(), executable: executable_type(), salt: salt_type()}

  defstruct [:network_id, :executable, :salt]

  @spec new(network_id :: network_id_type(), executable :: executable_type(), salt :: salt_type()) :: t()
  def new(
    %Hash{} = network_id,
  ...
  def decode_xdr(bytes, struct) do
    case XDR.Struct.decode_xdr(bytes, struct) do
      {:ok, {%XDR.Struct{components: [network_id: network_id, executable: executable, salt: salt]}, rest}} ->
