defmodule StellarBase.XDR.StateExpirationSettings do
  ...
  defstruct [:max_entry_expiration, :min_temp_entry_expiration, :min_persistent_entry_expiration, :auto_bump_ledgers, :persistent_rent_rate_denominator, :temp_rent_rate_denominator, :max_entries_to_expire, :bucket_list_size_window_sample_size, :eviction_scan_size]
  ...
  def decode_xdr(bytes, struct) do
    case XDR.Struct.decode_xdr(bytes, struct) do
      {:ok, {%XDR.Struct{components: [max_entry_expiration: max_entry_expiration, min_temp_entry_expiration: min_temp_entry_expiration, min_persistent_entry_expiration: min_persistent_entry_expiration, auto_bump_ledgers: auto_bump_ledgers, persistent_rent_rate_denominator: persistent_rent_rate_denominator, temp_rent_rate_denominator: temp_rent_rate_denominator, max_entries_to_expire: max_entries_to_expire, bucket_list_size_window_sample_size: bucket_list_size_window_sample_size, eviction_scan_size: eviction_scan_size]}, rest}} ->
        {:ok, {new(max_entry_expiration, min_temp_entry_expiration, min_persistent_entry_expiration, auto_bump_ledgers, persistent_rent_rate_denominator, temp_rent_rate_denominator, max_entries_to_expire, bucket_list_size_window_sample_size, eviction_scan_size), rest}}
      error -> error
    end
  end
  ...
  def decode_xdr!(bytes, struct) do
    ...
    {new(max_entry_expiration, min_temp_entry_expiration, min_persistent_entry_expiration, auto_bump_ledgers, persistent_rent_rate_denominator, temp_rent_rate_denominator, max_entries_to_expire, bucket_list_size_window_sample_size, eviction_scan_size), rest}
  end
end
