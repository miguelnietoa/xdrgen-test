defmodule StellarBase.XDR.LedgerEntryList do
  @moduledoc """
  ...
  Representation of Stellar `LedgerEntryList` type.
  """
  ...
  @array_type LedgerEntry

  @array_spec %{type: @array_type}

  @type t :: %__MODULE__{items: list(LedgerEntry.t())}

  defstruct [:items]

  @spec new(items :: list(LedgerEntry.t())) :: t()
