defmodule StellarBase.XDR.SorobanTransactionData do
  ...
  @type t :: %__MODULE__{resources: resources_type(), refundable_fee: refundable_fee_type(), ext: ext_type()}

  defstruct [:resources, :refundable_fee, :ext]

  @spec new(resources :: resources_type(), refundable_fee :: refundable_fee_type(), ext :: ext_type()) :: t()
  def new(
  ...
  def decode_xdr(bytes, struct) do
    case XDR.Struct.decode_xdr(bytes, struct) do
      {:ok, {%XDR.Struct{components: [resources: resources, refundable_fee: refundable_fee, ext: ext]}, rest}} ->
  ...
  def decode_xdr!(bytes, struct) do
    {%XDR.Struct{components: [resources: resources, refundable_fee: refundable_fee, ext: ext]}, rest} =
