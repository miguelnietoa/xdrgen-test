defmodule StellarBase.XDR.TTLEntry do
  ...
  @type t :: %__MODULE__{key_hash: key_hash_type(), live_until_ledger_seq: live_until_ledger_seq_type()}
  ...
  def decode_xdr(bytes, struct) do
    case XDR.Struct.decode_xdr(bytes, struct) do
      {:ok, {%XDR.Struct{components: [key_hash: key_hash, live_until_ledger_seq: live_until_ledger_seq]}, rest}} ->
  ...
  def decode_xdr!(bytes, struct) do
    {%XDR.Struct{components: [key_hash: key_hash, live_until_ledger_seq: live_until_ledger_seq]}, rest} =
