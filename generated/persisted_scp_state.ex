defmodule StellarBase.XDR.PersistedSCPState do
  @moduledoc """
  ...
  Representation of Stellar `PersistedSCPState` type.
  """
  ...
  @arms %{
    0 => PersistedSCPStateV0,
    1 => PersistedSCPStateV1
  }

  @type value ::
          PersistedSCPStateV0.t()
          | PersistedSCPStateV1.t()
