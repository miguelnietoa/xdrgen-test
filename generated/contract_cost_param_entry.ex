defmodule StellarBase.XDR.ContractCostParamEntry do
  ...
  @type t :: %__MODULE__{ext: ext_type(), const_term: const_term_type(), linear_term: linear_term_type()}

  defstruct [:ext, :const_term, :linear_term]

  @spec new(ext :: ext_type(), const_term :: const_term_type(), linear_term :: linear_term_type()) :: t()
  def new(
    %ExtensionPoint{} = ext,
    %Int64{} = const_term,
    %Int64{} = linear_term
  ...
  def decode_xdr(bytes, struct) do
    case XDR.Struct.decode_xdr(bytes, struct) do
      {:ok, {%XDR.Struct{components: [ext: ext, const_term: const_term, linear_term: linear_term]}, rest}} ->
